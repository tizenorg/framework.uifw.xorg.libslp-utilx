 ...
 * @defgroup UTILX_MODULE utilX
 * @brief Samsung Linux platform X11 utilties
 *
 * @section UTILX_MODULE_HEADER Required Header
 * \#include <utilX.h>
 * @section UTILX_MODULE_OVERVIEW Overview
 * The utilX is common X11 utility.
 * It provides functions used by xclients, mainly to get or set state of X11 resources's information.
 */

/**
* @addtogroup UTILX_MODULE
* @{
*/
 ...
 *
 * @details This function sets the priority level of the notification windows.\n
 ...
 *
 *
 * @remarks This is used only notification window.
 * @param[in] dpy Specifies the connection to the X server
 ...
 *
 * @details This function establishs a grab of the specified key for the specified window.\n
 ...
 *
 * @remarks If utilx_grab_key() returns 0, the specified window will get the events of the specified key.\n
 ...
 * @brief Sets a window's effect style with effect type, asynchronously.
 *
 * @details This function sets a window's effect style with effect type.\n
 ...
 *
 * @remarks This is used only client window. ( not root window )
 * @param[in] dpy Specifies the connection to the X server
 * @param[in] win Specifies the window handle
 ...
 *
 * @details This function can make a framebuffer visible or non-visible. \n
